            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="hover:text-yellow-300 transition">소개</a></li>
                  <li><a href="#" className="hover:text-yellow-300 transition">사용 방법</a></li>
                  <li><a href="#" className="hover:text-yellow-300 transition">자주 묻는 질문</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="hover:text-yellow-300 transition">고객 지원</a></li>
                  <li><a href="#" className="hover:text-yellow-300 transition">피드백</a></li>
                  <li><a href="#" className="hover:text-yellow-300 transition">제휴 문의</a></li>
                </ul>
              </div>
