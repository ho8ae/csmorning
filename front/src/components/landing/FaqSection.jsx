  ...
  const faqs = [
    {
      ...
      answer: '매일 아침 CS 관련 문제를 제공하여, 개발자들이 CS 지식을 쌓을 수 있도록 돕는 서비스입니다. 문제는 매일 업데이트되며, 다양한 난이도와 주제를 포함하고 있습니다. 현재 개발 관련 토론 커뮤니티, 개발자 오늘의 뉴스, 그리고 깃허브의 잔디 기능과 같은 사용자 편의성에 관련된 기능들을 계속해서 구상하고 있습니다. 대시보드를 통해 확인하실 수 있고, 여러 기능 맛 보기를 통해서 체험하실 수 있습니다. :)'
    },
    {
      question: '매일 알림을 받으려면 어떻게 해야 하나요?',
      answer: '채널 추가 이후 채널 내에 간편 회원가입이나 사이트 회원가입 후 계정 연동을 통해 매일 아침 알림을 받을 수 있습니다. 알림톡 서비스는 회원님의 휴대폰 번호로 발송되는 점 참고해주시면 감사하겠습니다 !'
    },
    {
    ...
    {
      question: '어떻게 이용하나요?',
      answer: '이용방법은 간단합니다. 채널 추가하고 회원가입 하시면 모든 기능을 무료로 이용하실 수 있습니다. 채널 추가 후 [서비스 소개] or [도움말]을 눌러보면 더 자세히 나와있습니다. 단, 알림톡은 회원가입 후 계정 연동을 하셔야 발송됩니다. 베타 테스트라 서 불편한 점이 있을 수 있지만, 피드백을 주시면 최대한 반영하도록 하겠습니다. '
    },
    {
    ...
    <section className="py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <button
            onClick={() => window.open('https://capable-hydrogen-361.notion.site/1dce7274f15f817d8b03fa46dc92c8c7?pvs=105', '_blank')}
